...
$(function () {    
    $("#button8").click(function () {
        $("#dialog8").dockmodal({
            ...
            buttons:[
                {
                    html:'Send',
                    buttonClass:'btn btn-send',
                    click:function (e, dialog) {
                        // do something when the button is clicked
                        alert("Your form submit code goes here");
                    }
                }
            ]
        });
    ...
    $("#btn_resume_tracker").click(function () {
        ...
        $("#resume_tracker").dockmodal({
            title:"Resume + Tracker Send Mail",
            initialState:"docked",
            width:600,
            buttons:[
                {
