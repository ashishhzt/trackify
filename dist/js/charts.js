...
*/
    ...
    var bardata1 = [['Sun', 10], ['Mon', 23], ['Tue', 18], ['Thu', 13], ['Fri', 17], ['Sat', 30]];

    $.plot('#barchart1', [bardata1], {
        series: {
            lines: {
                lineWidth: 1
            },
    ...
    var bardata2 = [['Sun', 10], ['Mon', 23], ['Tue', 18], ['Thu', 13], ['Fri', 17], ['Sat', 30]];

    $.plot('#barchart2', [bardata2], {
        series: {
            lines: {
                lineWidth: 1
            },
    ...
    var bardata3 = [['Sun', 10], ['Mon', 23], ['Tue', 18], ['Thu', 13], ['Fri', 17], ['Sat', 30]];

    $.plot('#barchart3', [bardata3], {
        series: {
            lines: {
                lineWidth: 1
            },
    ...
    var bardata4 = [['Sun', 10], ['Mon', 23], ['Tue', 18], ['Thu', 13], ['Fri', 17], ['Sat', 30]];

    $.plot('#barchart4', [bardata4], {
        series: {
            lines: {
                lineWidth: 1
            },
    ...
    var bardata5 = [['Sun', 10], ['Mon', 23], ['Tue', 18], ['Thu', 13], ['Fri', 17], ['Sat', 30]];

    $.plot('#barchart5', [bardata5], {
        series: {
            lines: {
                lineWidth: 1
            },
    ...
    var bardata6 = [['Monday', 10], ['Tuesday', 23], ['Wednesday', 18], ['Thursday', 13], ['Friday', 17], ['Saturday', 30], ['Sunday', 26]];

    $.plot('#barchart6', [bardata6], {
        series: {
            lines: {
                lineWidth: 1
            },
        ...
        tooltip: {
            show: true,
            content: '<div style="background-color: #000; border: 1px solid #000; padding: .25em"><h4 style>%s</h4><ul><li>Y is %y</li></ul></div>',
    ...
    var bardata7 = [[0, 4], [1, 12], [2, 2], [3, 20]];
    var ticks = [[0, "Feedback"], [1, "Interview"], [2, "Offer"], [3, "Joining"]];

    $.plot('#barchart7', [bardata7], {
        series: {
            lines: {
                lineWidth: 1
            },
    ...
    var bardata8 = [['0 2 Days', 4], ['2 5 Days', 12], ['5 8 Days', 2], ['8 10 Days', 20], ['10 Days', 20]];

    $.plot('#barchart8', [bardata8], {
        series: {
            lines: {
                lineWidth: 1
            },
