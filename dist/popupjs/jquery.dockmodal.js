        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                if ($this.options.showClose) {
                    $('<a href="#" class="header-action action-close" title="Close"><i class="fa fa-close"></i></a>').appendTo($dockHeader).click(function (e) {
                        methods.destroy.apply($this);
                        return false;
                    });
                }
                if ($this.options.showPopout) {
                    $('<a href="#" class="header-action action-popout" title="Pop out"><i class="fa fa-expand"></i></a>').appendTo($dockHeader).click(function (e) {
                ...
                if ($this.options.showMinimize) {
                    $('<a href="#" class="header-action action-minimize" title="Minimize"><i class="fa fa-minus"></i></a>').appendTo($dockHeader).click(function (e) {
